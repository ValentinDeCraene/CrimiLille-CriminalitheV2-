...
class RechercheForm(FlaskForm):
    ...
    sexe = SelectField('Sexe', choices=[('', 'Sélectionner...'), ('M', 'Masculin'), ('F', 'Féminin'), ('NR', 'Non renseigné')])
    ...
    moment = SelectField('Moment', choices=[('', 'Sélectionner...'), ('J', 'Jour'), ('N', 'Nuit'), ('NR', 'Non renseigné')])
...
# Brigandage/vie sur le pays
# Désobéissance
# NR
# abus d'appel en justice
# assaut d\'une maison
# atteinte biens d\'autrui
# autre
# défaut de comparution
# faute entretien héritage
# injures
# jeux de hasard
# port armes nues
# rapt
# solidarité envers bannis
# tapage nocturne
# transgression édit/main de justice
# usure
# viol
# violence physique
# vol
